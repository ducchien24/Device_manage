...
import { Paper, Box, Typography, List, ListItemButton, ListItemIcon, ListItemText, Divider } from '@mui/material';
...
const menuItems = [
  ...
  { path: '/thoi-gian', text: 'Tra Cứu Thời Gian', icon: <CalendarMonthIcon /> },
];

export default function Sidebar() {
  return (
    <Paper elevation={0} sx={{ width: 280, bgcolor: '#1e293b', color: '#f8fafc', borderRadius: 0, display: 'flex', flexDirection: 'column', height: '100%' }}>
      <Box sx={{ p: 2.5, bgcolor: '#0f172a' }}>
        <Typography variant="h6" fontWeight="bold" color="#38bdf8" letterSpacing={0.5}>IT ASSET ADMIN</Typography>
        <Typography variant="caption" color="#94a3b8">Hệ thống quản lý tài sản v2.0</Typography>
      </Box>
